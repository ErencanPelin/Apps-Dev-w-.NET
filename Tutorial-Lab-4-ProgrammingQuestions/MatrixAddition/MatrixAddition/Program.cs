...
namespace Week5LabProgram
{
    class Matrix
    {
        ...
        public Matrix()
        {
            ...
            dimension = int.Parse(userInput); /*Complete the code*/
            matrix = new double[dimension, dimension]; /*Complete the code*/
            ...
            for (int outerLoop = 0; outerLoop < dimension; outerLoop++)
            {
                for(int innerLoop = 0; innerLoop < dimension; innerLoop++)
                {
                    ...
                    matrix[outerLoop, innerLoop] = double.Parse(userInput); /*Complete the code*/
                }
                Console.WriteLine();
            }
        }
        ...
        {
            this.matrix = new double[dim, dim]; /*Complete the code*/
