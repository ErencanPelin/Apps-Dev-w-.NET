...
namespace Week5LabProgram
{
    ...
    class QuadraticEquation
    {
        ...
        private double a, b, c, real_val, img_val;
        ...
        // Complete the code for Overloaded Constructor
        ...
        {
            if (img_val == 0)
                Console.WriteLine($"The Result is: x= {real_val}");
            else
                Console.WriteLine($"The Result is: x= {real_val}, {img_val}");
        }
    }
