...
namespace Week8Program1
{
    ...
    public class MyGenericStack<T>
    {
        ...
        public void Push(T value)
        {
            ...
            if (top < stackElements.Length) return;
            // Increment top
            top++;
        ...
        public T Pop()
        {
            ...
            if (top < 0) throw new StackOverflowException("Empty stack");
            // Decrement top
            top--;
